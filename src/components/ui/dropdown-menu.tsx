...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-44 overflow-hidden rounded-xl border border-border bg-popover p-1.5 text-popover-foreground shadow-2",
        "data-[state=open]:animate-[fade-up_0.16s_cubic-bezier(0.16,1,0.3,1)] data-[state=closed]:opacity-0",
        className,
      )}
      {...props}
    />
