...
const RULES: BuildingDef[] = [
  ...
  { id: "AG", name: "Nelson's Dockyard", image: "/buildings/ag.png" },
  { id: "AO", name: "Fortaleza de São Miguel", image: "/buildings/ao.png" },
  { id: "AS", name: "Traditional Samoan Fale", image: "/buildings/as.png" },
  { id: "AW", name: "California Lighthouse", image: "/buildings/aw.png" },
  { id: "AX", name: "Kastelholm Castle", image: "/buildings/ax.png" },
  { id: "BI", name: "Livingstone-Stanley Monument", image: "/buildings/bi.png" },
  { id: "BM", name: "St. George's Town Hall", image: "/buildings/bm.png" },
  { id: "BN", name: "Sultan Omar Ali Saifuddin Mosque", image: "/buildings/bn.png" },
  { id: "BS", name: "Government House", image: "/buildings/bs.png" },
  { id: "BT", name: "Paro Taktsang (Tiger's Nest)", image: "/buildings/bt.png" },
  { id: "BZ", name: "Xunantunich", image: "/buildings/bz.png" },
  { id: "CD", name: "Kinshasa Central Station", image: "/buildings/cd.png" },
  { id: "CF", name: "Bangui Cathedral", image: "/buildings/cf.png" },
  { id: "CG", name: "Basilica of Sainte-Anne du Congo", image: "/buildings/cg.png" },
  { id: "CV", name: "Fortaleza Real de São Filipe", image: "/buildings/cv.png" },
  { id: "DJ", name: "Hamoudi Mosque", image: "/buildings/dj.png" },
  { id: "DM", name: "Fort Shirley", image: "/buildings/dm.png" },
  { id: "EH", name: "Cape Boujdour Lighthouse", image: "/buildings/eh.png" },
  { id: "ER", name: "Fiat Tagliero Building", image: "/buildings/er.png" },
  { id: "FK", name: "Christ Church Cathedral", image: "/buildings/fk.png" },
  { id: "FM", name: "Nan Madol", image: "/buildings/fm.png" },
  { id: "GA", name: "Sainte-Marie Cathedral", image: "/buildings/ga.png" },
  { id: "GD", name: "Fort George", image: "/buildings/gd.png" },
  { id: "GL", name: "Hvalsey Church", image: "/buildings/gl.png" },
  { id: "GN", name: "Grand Mosque of Conakry", image: "/buildings/gn.png" },
  { id: "GP", name: "Basse-Terre Cathedral", image: "/buildings/gp.png" },
  { id: "GQ", name: "Malabo Cathedral", image: "/buildings/gq.png" },
  { id: "GU", name: "Dulce Nombre de Maria Cathedral-Basilica", image: "/buildings/gu.png" },
  { id: "GW", name: "Amura Fortress", image: "/buildings/gw.png" },
  { id: "IL", name: "Bahá'í Gardens", image: "/buildings/il.png" },
  { id: "IM", name: "Castle Rushen", image: "/buildings/im.png" },
  { id: "KI", name: "National Maneaba", image: "/buildings/ki.png" },
  { id: "KM", name: "Badjanani Mosque", image: "/buildings/km.png" },
  { id: "KY", name: "Pedro St. James Castle", image: "/buildings/ky.png" },
  { id: "LC", name: "Castries Town Hall", image: "/buildings/lc.png" },
  { id: "LY", name: "Leptis Magna", image: "/buildings/ly.png" },
  { id: "ME", name: "Ostrog Monastery", image: "/buildings/me.png" },
  { id: "MH", name: "Assumption Cathedral", image: "/buildings/mh.png" },
  { id: "MQ", name: "Cathedral of Saint-Louis", image: "/buildings/mq.png" },
  { id: "MU", name: "Fort Adelaide", image: "/buildings/mu.png" },
  { id: "MW", name: "Malawi Parliament Building", image: "/buildings/mw.png" },
  { id: "PF", name: "Cathedral of Notre-Dame de Papeete", image: "/buildings/pf.png" },
  { id: "PG", name: "Parliament Haus, Port Moresby", image: "/buildings/pg.png" },
  { id: "PS", name: "Church of the Nativity", image: "/buildings/ps.png" },
  { id: "PW", name: "Airai Bai", image: "/buildings/pw.png" },
  { id: "RE", name: "Cathedral of Saint-Denis", image: "/buildings/re.png" },
  { id: "SB", name: "National Parliament House", image: "/buildings/sb.png" },
  { id: "SC", name: "Victoria Clock Tower", image: "/buildings/sc.png" },
  { id: "SL", name: "St. George's Cathedral", image: "/buildings/sl.png" },
  { id: "SO", name: "Mogadishu Cathedral", image: "/buildings/so.png" },
  { id: "SS", name: "Dr. John Garang Memorial", image: "/buildings/ss.png" },
  { id: "ST", name: "Fortaleza de São Sebastião", image: "/buildings/st.png" },
  { id: "SZ", name: "Embo State Palace", image: "/buildings/sz.png" },
  { id: "TC", name: "Cheshire Hall Plantation", image: "/buildings/tc.png" },
  { id: "TD", name: "N'Djamena Grand Mosque", image: "/buildings/td.png" },
  { id: "TG", name: "Sacred Heart Cathedral", image: "/buildings/tg.png" },
  { id: "TL", name: "Cristo Rei of Dili", image: "/buildings/tl.png" },
  { id: "TO", name: "Royal Palace of Tonga", image: "/buildings/to.png" },
  { id: "TV", name: "Tuvalu Government Building", image: "/buildings/tv.png" },
  { id: "VC", name: "Fort Charlotte", image: "/buildings/vc.png" },
  { id: "VU", name: "Parliament House of Vanuatu", image: "/buildings/vu.png" },
  { id: "WS", name: "Vailima", image: "/buildings/ws.png" },
  { id: "ZM", name: "Victoria Falls Bridge", image: "/buildings/zm.png" },
  { id: "ZW", name: "Great Zimbabwe", image: "/buildings/zw.png" },
];
